//location of the java class in the package
...
// if the class is declared as final, we can not subclass/ inherit/extend the class
public class Employee implements Serializable{
	//Serializable as marker interface to manage serialization
	//causes ObjectOutput/InputStream classes
	...
	private Grades grade; //transient keyword will denote the serializer to skip this 
	...
	static { //used to initialise all the static members of the class
		System.out.println("Employee Static Block Called");
	}
	
	//instance block: executed before the constructor is called for any object of class
	{
		setEmpno(999);
		setName("example");
	...
	public Employee(int empno, String name, double unitDaySalary, Designations designation) {
		...
		System.out.println("Employee Master Default Constructor Called");
		System.out.println("eno: "+getEmpno()+",name:"+getName()+
				",unit Salary:"+getUnitDaySalary()+",designation:"+getDesignation());
	...
	//final key words or method
	//final methods can not be overwritten in the derived class
	...
	public int hashCode() {
		...
		long temp;
		temp = Double.doubleToLongBits(unitDaySalary);
	...
	public boolean equals(Object obj) {
		...
		if (name == null) {
			...
			return false;
		if (Double.doubleToLongBits(unitDaySalary) != Double.doubleToLongBits(other.unitDaySalary))
			return false;
		return true;
	}
